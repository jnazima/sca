...
<tr>
<td>
<li><a href="index.php?modulo=buscar_por_nome_mae">Buscar por nome da m&atilde;e.</a></td></li>
</td>
</tr>
...
<table>
<form name="busca" id="busca" method="post" action="index.php?modulo=maternidade">
<tr>
<td width="192" colspan="3">
Pesquisar pelo nome do rec&eacute;m nascido.
</td>
...
<td>
<input type="submit" name="btn_pesquisa" value="Buscar" onclick="index.php?modulo=maternidade" />&nbsp;
</td>
<td>
<input type="button" name="btncancelar" value="Limpar" onclick="document.location='index.php?modulo=maternidade';"  />
</td>
...
Nenhum item corresponde &aacute; sua pesquisa.<br />';
								echo 'Verifique o  <font color="#FF0000">nome do rec&eacute;m nascido</font> ou contacte o administrador do sistema.</b></center>';
								echo '</fieldset>';
							}
							...
							echo '   <td width="20%" align="left" class="style2"> <b> Data Nascimeto </b> </td>';
							echo '   <td width="20%" align="center" colspan="3" class="style2"> <b> Op&ccedil;&otilde;es </b> </td>';
							echo ' </tr>';
							}
							while($i <= $rows )
							{
								...
								{	
									...
									//aqui coloca a cor no tabela
										...
										echo '<a href="index.php?modulo=maternidade_ficha&acao=alterar&cod_rec_nascido='.$dados['cod_rec_nascido'].'">&nbsp; <img src="Imagens/alterar.gif" title="Altera Registro" /> </a>';  echo'</td>';
										echo '   <td>'; 
