...
//-----------------------------------------------------------
function excluir(nome, cod_convenio)
{
	if(confirm ("Deseja realmente excluir este convênios  '" + nome + "'?") )
	{
		document.location = "convenios_gravar.php?acao=excluir&cod_convenio=" + cod_convenio;
	}
}
//-------------------------------------------------------------------------------

function abrir_fotos(cod_convenio)//Aqui fica a funcao que abre uma outra tela para inclusão de fotos dos produtos...
{
	window.open('fotos_convenios.php?cod_convenio='+cod_convenio,'fotos','status=yes,toolbar=no,location=no,menubar=no,scrollbars=yes,height=430,width=750,top=200,left=300');
...
<div id="div_convenios_tudo">
<div id="div_nome_modulo">Cadastro de Conv&ecirc;nios</div><!---div_nome_modulo----->

<div id="div_busca_convenios"><!---- aqu abre a div convenios----->
<table>
...
<td>
<input type="button" name="btncancelar" value="Limpar" onclick="document.location='index.php?modulo=convenios';"  />
</td>


</form>
</table>
</div><!----div fecha busca convenios ------>
...
Nenhum item corresponde &aacute; sua pesquisa.<br />';
								echo 'Verifique o  <font color="#FF0000">nome do conv&ecirc;nio</font> ou contacte o administrador do sistema.</b></center>';
								echo '</fieldset>';
							}
							...
							if($rows>0)
							{
								...
								echo '   <td width="50%" align="left"> <b>Conv&ecirc;nios</b> </td>';
								echo '   <td width="25%" align="left" > <b>U.R.L </b> </td>';
								echo '   <td width="25%" align="center" colspan="3"> <b> Op&ccedil;&otilde;es </b> </td>';
								echo ' </tr>';
							}
							while($i <= $rows )
							{
								...
								{	
			...
			
									{
										...
										echo '   <td align="left">'.$dados['url'].'</td>';
										echo '   <td align="center">'; 
										
										echo '<a href="index.php?modulo=convenios_ficha&acao=alterar&cod_convenio='.$dados['cod_convenio'].'"> &nbsp;<img src="Imagens/alterar.gif" title="Alterar" /> </a>';  
										 echo'</td>';
										 echo '   <td align="center">'; 
										
										echo '<a href="javascript:excluir(\''.$dados['nome'].'\','.$dados['cod_convenio'].');">&nbsp; <img src="Imagens/Symbol Delete.gif" width="13" title="Excluir"  /> </a>';  
										echo'</td>';
										echo '   <td align="center">'; 
										
										echo '<a href="javascript:abrir_fotos('.$dados['cod_convenio'].');">&nbsp;<img src="Imagens/Correct.gif" width="13" title="Adiciona Fotos" /></a>';//funcao carrega fotos
...
echo '<p align="right"><a href="index.php?modulo=convenios_ficha&acao=incluir"> + Adicionar Conv&ecirc;nio </a>';
echo'</div>';										
