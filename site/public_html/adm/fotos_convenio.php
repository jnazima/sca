...
<form action="fotos_convenio.php?acao=i&amp;cod_convenio=<?php echo $cod_convenio; ?>" onsubmit="return validar_foto();" method="post" enctype="multipart/form-data"name="form1" id="form1">
