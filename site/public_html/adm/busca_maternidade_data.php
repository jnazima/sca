...
// validando o campo DATA DE inicio
	if( !verificaData(document.busca.data_nascimento_inicio.value) )
	{
		alert("O campo Data do Nascimento do recenascido deve ser preechido com uma data válida !");
		document.busca.data_nascimento_inicio.focus();
		document.busca.data_nascimento_inicio.select();
		return;
	}
//-------------------------------------------------------------------------------
// validando o campo DATA DE inicio
	if( !verificaData(document.busca.data_nascimento_final.value) )
	{
		alert("O campo Data do Nascimento do recenascido deve ser preechido com uma data válida !");
		document.busca.data_nascimento_final.focus();
		document.busca.data_nascimento_final.select();
		return;
	}
...
<tr>
<td>
<li><a href="index.php?modulo=buscar_por_nome_mae">Buscar por nome da m&atilde;e.</a></li>
</td>
</tr>
<tr>
<td>
...
<table align="center">
<form name="busca" id="busca" method="post" action="index.php?modulo=busca_maternidade_data">
<tr>
<td>
Data de inicio.
</td>
...
<tr>
<td>
<input type="text" id="data_nascimento_inicio" name="data_nascimento_inicio" size="20" value="<?php echo $data_nascimento_inicio; ?>" onkeyup="maskIt(this,event,'##/##/####')" /> 
</td>
<td>
<input type="text" id="data_nascimento_final" name="data_nascimento_final" size="20" value="<?php echo $data_nascimento_final; ?>" onkeyup="maskIt(this,event,'##/##/####')" />
</td>
<td>
<input type="submit" name="btn_pesquisa" value="Buscar" onclick="index.php?modulo=busca_maternidade_data" />&nbsp;
</td>
<td>
<input type="button" name="btncancelar" value="Limpar" onclick="document.location='index.php?modulo=busca_maternidade_data';"  />
</td>
    ...
    <div id="conteudo">
     <?php	
					 $data_inicio = DataBR_to_USA( $_POST['data_nascimento_inicio'] );
					 $data_final = DataBR_to_USA( $_POST['data_nascimento_final'] );
							...
							if(isset($_POST['data_nascimento_inicio']) && isset($_POST['data_nascimento_final']))
							{	
							   $sql.="where data_nascimento >="."'".$data_inicio."'"." and data_nascimento <= "."'".$data_final."'";
							//echo $sql; exit;
...
Nenhum item corresponde &aacute; sua pesquisa.<br />';
								echo 'Verifique a <font color="#FF0000">data de inicio </font>ou <font color="#FF0000">data final</font> ou contacte o administrador do sistema.</b></center>';
								echo '</fieldset>';
							}
							...
							echo '   <td width="60%" align="left" class="style2"> <b> Nome </b> </td>';
							echo '   <td width="25%" align="left" class="style2"> <b> Data Nascimeto </b> </td>';
							echo '   <td width="15%" align="center" colspan="2" class="style2"> <b> Op&ccedil;&otilde;es </b> </td>';
							echo ' </tr>';
							}
							while($i <= $rows )
							{
								...
								{	
									...
									//aqui coloca a cor no tabela
										...
										echo '   <td align="left" >  ' .DataUSA_to_BR(  $dados['data_nascimento']) . '  </td>';
