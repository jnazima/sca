...
/*-----------------------------------------------------------------*/
#conteudo tr:hover /* aqui faz o efeito na tabela de registros*/
{
...
<div id="div_nome_modulo">Cadastro de Curriculum Desativados </div><!---div_nome_modulo----->
...
<table>
<form name="busca" id="busca" method="post" action="index.php?modulo=curriculumdesativados">
<tr>
<td>
Pesquisar 
</td>
...
<td><select name="estado_civil" id="estado_civil" onchange="busca_estado_civil_curriculos_desativados();">
      ...
      <tr><td colspan="2">Setor</td></tr>
    <tr>
     <td colspan="2">
    <select name="cod_setor" id="cod_setor" onchange="busca_setor_curriculum_desativados();">
    ...
    <tr>
<td >
<input type="submit" name="btn_pesquisa" value="Buscar" onclick="index.php?modulo=curriculumdesativados" />&nbsp;
&nbsp;
<input type="button" name="btncancelar" value="Limpar" onclick="document.location='index.php?modulo=curriculumdesativados';"  />
</td>
</tr>
...
<div id="div_estadocivil">
    <div id="conteudo">
     <?php	
							...
							if(isset($_POST['nome']))
							{	
							   $sql.=" where nome like'%".$_POST['nome']."%'and situacao =2";
							}
...
Nenhum item corresponde &aacute; sua pesquisa.<br />';
							...
							echo '   <td width="50%" align="left"> <b>Nome do Candidato </b> </td>';
							echo '   <td width="10%" align="center"> <b>Situa&ccedil;&atilde;o </b> </td>';
							echo '   <td width="20%" align="center"> <b>Data Cadastro </b> </td>';
