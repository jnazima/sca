...
<fieldset>
 <div id="captchaimage"><a href="<?php echo $_SERVER['../../../../../funcoes/jquery-validate/demo/captcha/PHP_SELF']; ?>" id="refreshimg" title="Click to refresh image"><img src="images/image.php?<?php echo time(); ?>" width="132" height="46" alt="Captcha image" /></a></div>
