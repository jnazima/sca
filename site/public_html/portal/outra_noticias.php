...
echo'</fieldset>';	
		...
		echo'<div id="div_nome_modulo">Noticias&nbsp;:..
		<a href="index.php?modulo=outra_noticias>outras not&iacute;cias</a>"</div>';//nome do modulo
			...
			echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.DataUSA_to_BR( $dados['data_noticia']);
			
					
            echo '<div id="div_subtitulos_noticia">' .$dados['subtitulo'].'</div>';
		    
			echo '<div id="div_link_noticia"><a href ="noticias/index.php?modulo=noticia&acao=ver_outras_noticias&cod_noticia='.$dados['cod_noticia'].'" >Leia mais...</a>'.'</div>';
